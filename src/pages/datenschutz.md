...
### Anonymisierte Webanalyse durch Netlify Analytics

Wir verwenden Netlify Analytics, um anonymisierte Statistiken über die Verwendung unserer Website zu erfassen. Wir tun das, um zu verstehen welche Inhalte am meisten von unseren Besuchern gelesen werden. Netlify Analytics ist ein Analysedienst, der den Datenschutz unserer Besucher respektiert. Das bedeutet, dass z.B. die Häufigkeit von Seitenaufrufen ohne die Zuordnung zu einer Person ermittelt wird. Zudem wird erfasst wieviele Kunden insgesamt unsere Seite besuchten und aus welchem Land sie die Website lesen, ohne dabei einzelne Kunden zu identifzieren. Das macht die Statistiken zwar ungenauer aber für uns ausreichend. Mehr Informationen dazu, wie Netlify Ihre Daten verarbeitet, können Sie deren Datenschutzerklärung sowie der Dokumentation von Netlify Analytics entnehmen.
